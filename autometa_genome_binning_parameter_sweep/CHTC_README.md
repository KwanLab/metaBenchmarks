...
python generate_param_sweep_list.py \
    --input /home/erees/autometa_runs/binning_param_sweep/data \
    --glob "*Mbp"
    --output sweep_parameters.txt
```

> This will allow use of `queue <var> from <list>` in submit file. e.g.:
>
...
```bash
python generate_param_sweep_list.py \
    --input /home/erees/autometa_runs/binning_param_sweep/data/cami \
    --glob "*assembly"
...
#### Parameter sweep benchmarking CAMI2 datasets
